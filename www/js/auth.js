        ...
        try {
            ...
            if (data.user) {
                ...
                if (profile) {
                    ...
                    errorMessage.textContent = 'Profilo utente non trovato. Si prega di contattare il supporto.';
                }
            }
...
if (signUpForm) {
    signUpForm.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            if (data.user) {
                message.textContent = 'Registrazione avvenuta con successo! Controlla la tua email per il link di conferma.';
                signUpForm.reset();
            }
